...
from occ.configs.globals import get_global
...
if __name__ == "__main__":
    ...
    parse.add_argument(
        "--visual_path",
        type=str,
        default="/mnt/data/huangbinling/project/occgen/outputs/occ_pcd_visual_cam0.npy",
    )
    parse.add_argument(
        "--visual_save_dir",
        type=str,
        default="/mnt/data/huangbinling/project/occgen/outputs/visual",
    )
